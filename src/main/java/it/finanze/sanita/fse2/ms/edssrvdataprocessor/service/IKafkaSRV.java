...
public interface IKafkaSRV {
	 ...
	 */
	void lowPriorityListenerPublishIngestor(ConsumerRecord<String, String> cr, int delivery) throws NoRecordFoundException, EmptyIdentifierException, OperationException;
	 ...
	 * @throws EmptyIdentifierException  An exception thrown when the document has an empty identifier 
	 */
	void mediumPriorityListenerPublishIngestor(ConsumerRecord<String, String> cr, int delivery) throws NoRecordFoundException, EmptyIdentifierException, OperationException;
	 ...
	 * @throws EmptyIdentifierException  An exception thrown when the document has an empty identifier 
	 */
	void highPriorityListenerPublishIngestor(ConsumerRecord<String, String> cr, int delivery) throws NoRecordFoundException, EmptyIdentifierException, OperationException;
	 ...
	 * @throws EmptyIdentifierException  An exception thrown when the document has an empty identifier 
	 */
	void genericListenerPublishIngestor(ConsumerRecord<String, String> cr, int delivery) throws NoRecordFoundException, EmptyIdentifierException, OperationException;
