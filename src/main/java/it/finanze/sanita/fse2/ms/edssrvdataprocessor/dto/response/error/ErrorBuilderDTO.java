...
public final class ErrorBuilderDTO {
    ...
    public static ErrorResponseDTO createArgumentMismatchError(LogTraceInfoDTO trace,
     ...
     * @return ErrorResponseDTO The error response
     */
    public static ErrorResponseDTO createUnsupportedOperationError(LogTraceInfoDTO trace,
